...
class LocationViewModel: ViewModel() {
   private var _listOfLOcationItems= MutableStateFlow(listOf<LocationData?>())
    val listOfLOcationItems= _listOfLOcationItems.asStateFlow()
...
fun AddLocationData(){
    _listOfLOcationItems.value = _listOfLOcationItems.value.plus(_userLocationData.value)
}
